    ...
    install(app, options) {
        options = merge({
            components: {
                ...
                'vue-speedometer': 'vue-speedometer'
            }
        }, options);
        ...
        app.component(options.components['vue-speedometer'], VueSpeedometer)
    }
}

export {VueCsvToggleHeaders, VueCsvSubmit, VueCsvMap, VueCsvTableMap, VueCsvInput, VueCsvErrors, VueCsvImport, VueCsvImportPlugin, VueSpeedometer};
